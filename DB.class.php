...
/**
 * "Обертка" для работы с SQL-базами данных через класс PDO (в стиле ООП)
 * ----------------------------------------------------------------------
 *
 * @version 0.1 -   повторение "обертки" для PDO от http://phpfaq.ru/pdo/pdo_wrapper
 * @version 0.2 -   добавлены методы: connect()
 *
 */

class GDB extends PDO
{
